    ...
    <div classNameName='AboutScreen'>
      <div className="row">
        ...
        <div className="side">
          <h2>About Us</h2>
          <br/>
          <div className="about-img" style={{height:'200px'}}>
            <img alt='delivery sofa' src={us} />
          </div>
          <p>Keep On Moving Edinbur provides an excellent full removal service 
          ...
          <br/>
          <div className="about-img">
            <img alt='furniture' src={fullyInsured} />
          </div>
          <br/>
        ...
        <div className="main">
          ...
          <br/>
          <p>KOM Edinburgh understand how stressfull moving house can be without professionals 
            ...
            moving furniture or moving boxes. Our professional disassemble and reassemble your furniture 
          ...
          small removal across Edinburgh. KOM provide a 
